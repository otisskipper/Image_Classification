...
//given a folder and a certain tag, reads in all images in certain folder
	...
	Picture[] allPics;
	Picture[] trainingSet; //70% of images
	Picture[] testingSet; //30% of images
	...
	public PictureCollection(String folderLocation, int type) throws IOException{
		...
		this.separateTrainingAndTesting();
	...
	public Picture[] getTrainingSetPictures(){
		return trainingSet;
	}
	public Picture[] getTestingSetPictures(){
		return testingSet;
	}
	...
	private void readInPictures(String folderLocation) throws IOException{
		...
		allPics = new Picture[listOfFiles.length];
